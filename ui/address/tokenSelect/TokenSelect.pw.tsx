...
test.beforeEach(async({ mockApiResponse, mockAssetResponse }) => {
  ...
  await mockApiResponse('address_tokens', tokensMock.erc20List, { pathParams: { hash: ADDRESS_HASH }, queryParams: { type: 'DRC-20' }, times: 1 });
  await mockApiResponse('address_tokens', tokensMock.erc721List, { pathParams: { hash: ADDRESS_HASH }, queryParams: { type: 'DRC-721' }, times: 1 });
  await mockApiResponse('address_tokens', tokensMock.erc1155List, { pathParams: { hash: ADDRESS_HASH }, queryParams: { type: 'DRC-1155' }, times: 1 });
  await mockApiResponse('address_tokens', tokensMock.erc404List, { pathParams: { hash: ADDRESS_HASH }, queryParams: { type: 'DRC-404' }, times: 1 });
});
...
test('long values', async({ render, page, mockApiResponse }) => {
  ...
  }, { pathParams: { hash: ADDRESS_HASH }, queryParams: { type: 'DRC-20' }, times: 1 });
  await mockApiResponse('address_tokens', {
    items: [ tokensMock.erc721LongSymbol ], next_page_params: null,
  }, { pathParams: { hash: ADDRESS_HASH }, queryParams: { type: 'DRC-721' }, times: 1 });
  await mockApiResponse('address_tokens', {
    items: [ tokensMock.erc1155LongId ], next_page_params: null,
  }, { pathParams: { hash: ADDRESS_HASH }, queryParams: { type: 'DRC-1155' }, times: 1 });
  await mockApiResponse('address_tokens', tokensMock.erc404List, { pathParams: { hash: ADDRESS_HASH }, queryParams: { type: 'DRC-404' }, times: 1 });
